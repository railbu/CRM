			...
			<div class="table1">
				<div class="panel panel-default">
 				...
 				<div class="panel-heading" style="height:40px">
					...
					<form action="${ctx}/admin/authority_save" method="post">
						<table class="table">
							<thead>
								<tr>
									<th>序号</th>
							...
							<tbody>
								...
								<s:iterator value="uaList" var="item" status="st">
									<tr>
										...
										<td><s:textfield name="uaList[%{#st.index}].authority.description" value="%{authority.description}"/></td>
										<%-- <td><s:textfield name="uaList[%{#st.index}].onoff" value="%{onoff}"/></td> --%>
