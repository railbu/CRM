...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
		<div class="sidebar" id="sidebar">
					<ul class="nav nav-list">
						...
						<c:if test="${fn:contains(sessionScope.authority,'service_')}">
						<li >
							<div class="hr_black"></div>
						...
						<li >
							...
							<ul class="submenu">
								<c:if test="${fn:contains(sessionScope.authority,'data_list')}">
								<li>
								...
								<c:if test="${fn:contains(sessionScope.authority,'goods_list')}">
								<li>
								...
								<c:if test="${fn:contains(sessionScope.authority,'leftgoods_list')}">
								<li>
