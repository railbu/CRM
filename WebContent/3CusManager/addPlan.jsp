			...
			<div class="navbar1">
				...
				<div class="table1">
					<div class="tabLabCon">
							...
							<c:if test="${fn:contains(sessionScope.authority,'plan_make')}">
				...
				<s:if test="message != null">
							<div class="alert alert-<s:property value="message.type"/>" style="font-size:15px;height:20px;line-height:0;width:60%;margin-left:3%">
