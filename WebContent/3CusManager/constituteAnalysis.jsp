					...
					<form action="${ctx}/3CusManager/analysize_constlist.action" class="form-inline" enctype="multipart/form-data" method="post">
						  <div class="form-group" style="width:60%">
						    <div class="input-group">
						      ...
						      <input id="iCheck" type="radio" value="1" name="check" checked>
						      <label>　按等级　　</label>
							  <input id="iCheck" type="radio" value="2" name="check">
							  <label>　按信用度　　</label>
