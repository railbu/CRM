...
<body>
		...
		<div class="mainc" id="mainc">
			...
			<div class="table1" style="margin-right:0px">
				 	<form action="service_arList" method="post">
				...
				<div class="table1" style="margin-right:0px">
						...
						<tbody>
							<s:iterator value="cslist" var="item" status="st">
								<tr>
									...
									<td><s:property value="formatItem(createTime)" /></td>
									<td><s:property value="state" /></td>
									
									<td>
										<s:url value="/3CusManager/service_arMI" id="feedback">
											<s:param name="cnmid" value="id" />
										</s:url> 
										<s:a href="%{feedback}" cssClass="button button-flat-primary button-tiny" style="height:32px">详情</s:a> 
									</td>
								</tr>
							</s:iterator>
						</tbody>
					...
					<div class="pageSelect">
						<ul class="pagination">
							...
							<s:url value="/3CusManager/service_arList" id="lpage">
							...
							<s:iterator value="pages" var="item">
								 <s:url value="/3CusManager/service_arList" id="page">
							...
							<s:url value="/3CusManager/service_arList" id="rpage">
