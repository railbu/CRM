...
<body>
	...
	var lineChartData = {
		labels : ["订单号<s:property value="s[0]" />",
		          "订单号<s:property value="s[1]" />",
		          "订单号<s:property value="s[2]" />",
		          "订单号<s:property value="s[3]" />",
		          "订单号<s:property value="s[4]" />",
		          "订单号<s:property value="s[5]" />",
		          "订单号<s:property value="s[6]" />"],
		datasets : [
					{
