...
<body>
		...
		<div class="mainc" id="mainc">
			...
			<div class="col-md-12">
				<div class="table1" style="margin-right:0px;padding:20px 30px 15px">
				 	<form action="service_dealList" method="post">
				...
				<div class="table1" style="margin-right:0px">
						...
						<tbody>
							<s:iterator value="cslist" var="item" status="st">
								<tr>
									...
									<td>
										<s:url value="/3CusManager/service_dealMI" id="deal">
											<s:param name="cnmid" value="id" />
										</s:url> 
										<s:a href="%{deal}" cssClass="button button-flat-primary button-tiny" style="height:32px">处理</s:a> 
									</td>
								</tr>
							</s:iterator>
						</tbody>
					...
					<div class="pageSelect">
						<ul class="pagination">
							...
							<s:url value="/3CusManager/service_dealList" id="lpage">
							...
							<s:iterator value="pages" var="item">
								 <s:url value="/3CusManager/service_dealList" id="page">
							...
							<s:url value="/3CusManager/service_dealList" id="rpage">
